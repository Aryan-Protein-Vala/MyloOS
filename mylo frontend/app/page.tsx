...
export default function Page() {
  ...
  return <main>
    ...
    <footer className="footer shell">
      <div className="brand"><span className="brand-mark"><img src="/icon.svg" alt="logo" className="inline-block w-[1em] h-[1em]" /></span><span><strong>MYLO</strong><small>[os-native agent]</small></span></div>
...
function DesktopMockup() { return <div className="desktop-mockup"><div className="window-bar"><span className="window-title"><CircleDot size={12} /> MYLO / OS Takeover</span><span>— □ ×</span></div><div className="desktop-content"><aside><span className="side-active">⌂</span><span>◫</span><span>◌</span><span>⚙</span></aside><div className="editor"><div className="editor-menu">File　 Edit　 View　 Export　 Help</div><div className="editor-stage"><div className="stage-shape" /><div className="stage-shape small" /><span className="stage-label">composition_04</span><div className="target-button">③ Click Export<RoughCircle /></div><RoughArrow /><div className="spotlight" /><div className="speech"><b>MYLO says:</b><br />Got the window handle. Exporting now.</div><div className="avatar"><img src="/icon.svg" alt="logo" className="inline-block w-[1em] h-[1em]" /></div></div><div className="editor-footer">● 00:12:48　　▶ timeline　　▰ export settings</div></div></div><div className="mock-caption"><span>live screen context</span><span><CircleDot size={12} /> agent running locally</span></div><div className="mt-2.5 flex items-center justify-center gap-2 rounded border-2 border-dashed border-[var(--ink)] bg-[var(--yellow)]/30 px-3 py-1.5 font-mono text-[11px] text-[var(--ink)] shadow-[2px_2px_0_var(--ink)] rotate-[-1deg]"><MousePointer2 size={13} className="text-[var(--blue)] flex-shrink-0" /><span>Your mouse moves on its own now. Don&apos;t panic, it&apos;s just doing your job.</span></div></div> }
function StealthDemo() { return <div className="stealth-demo"><div className="stealth-pane them"><div className="pane-label"><EyeOff size={14} /> What Zoom / OBS sees</div><div className="pane-screen"><div className="pane-bar"><span /><span /><span /><small>presentation_final.pptx</small></div><div className="pane-body"><div className="pane-slide"><span className="slide-title">Q3 Revenue Report</span><div className="slide-chart"><i style={{ height: '60%' }} /><i style={{ height: '80%' }} /><i style={{ height: '45%' }} /><i style={{ height: '90%' }} /><i style={{ height: '70%' }} /></div></div></div><div className="clean-badge"><Check size={13} /> Clean screen — no AI visible</div></div></div><div className="stealth-vs"><span>VS</span></div><div className="stealth-pane you"><div className="pane-label"><Eye size={14} /> What you actually see</div><div className="pane-screen"><div className="pane-bar"><span /><span /><span /><small>presentation_final.pptx</small></div><div className="pane-body"><div className="pane-slide"><span className="slide-title">Q3 Revenue Report</span><div className="slide-chart"><i style={{ height: '60%' }} /><i style={{ height: '80%' }} /><i style={{ height: '45%' }} /><i style={{ height: '90%' }} /><i style={{ height: '70%' }} /></div></div><div className="mylo-overlay-card"><div className="overlay-dot"><img src="/icon.svg" alt="logo" className="inline-block w-[1em] h-[1em]" /></div><b>MYLO whispers:</b><p>&quot;Revenue up 23% — credit the APAC expansion.&quot;</p></div><div className="mylo-overlay-hint"><span>③ Next slide: cost breakdown</span><RoughCircle className="hint-circle" /></div></div></div></div></div> }
