...
const modes = {
  ...
  v1: { label: 'THE KITCHEN SINK', title: 'The OG features you didn\'t ask for but we delivered.', copy: 'We didn\'t kill the V1 classics. Use ASK MODE for quick voice questions, COACH MODE when you actually want to learn how to do it yourself, and DO MODE when you want MYLO to take the wheel. All the OG goodness packed into one tab.', color: 'yellow', icon: Package },
} as const
  ...
  return <main>
      ...
      <div className={`mode-panel ${modes[mode].color}`}>
        ...
        <div className="mode-preview">
          ...
          <div className="preview-body">
            ...
            {mode === 'v1' && <>
              <div className="coach-callout" style={{ right: '15px', top: '50px', animation: 'v1-float1 4s ease-in-out infinite' }}><b>Coach Mode</b> <br/>Open Terminal, I&apos;ll walk you through the Git rebase.<RoughCircle/></div>
              <div className="ask-card" style={{ top: '155px', left: '8%', animation: 'v1-float2 3.5s ease-in-out infinite reverse', zIndex: 5 }}><div className="audio"><span/><span/><span/><span/><span/><span/><span/><span/></div><b>Ask Mode</b><p>You asked: "What is this error?"</p></div>
              <div className="task-card" style={{ top: '25px', left: '20%', animation: 'v1-float3 4.5s ease-in-out infinite', zIndex: 1, opacity: 0.85 }}><b>Do Mode</b><small>Taking over terminal...</small></div>
            </>}
          </div>
        </div>
      </div>
    ...
    <section id="pricing" className="section shell">
      ...
      <div className="pricing-grid">
        ...
        <PriceCard title="MYLO Elite" price="$49.99" suffix="/ month" badge="The Whole Damn Thing" items={['Unlimited Cortex memory — it never forgets anything','Heavy reasoning models: Claude 4.6, o3','Background agent spawning — works while you sleep','Premium ElevenLabs voice — it sounds alive']} cta="Get Elite Access"/>
      </div>
    </section>
